...
from main import create_news_letter
...
def load_setup():
    ...
    logging.info("active: %s, days: %s, release_time_str: %s, seconds_between_checks: %s, whitelisted_senders: %s", active, days, release_time_str, seconds_between_checks, whitelisted_senders)
    return active, days, release_time_str, seconds_between_checks, whitelisted_senders

active, days, release_time_str, seconds_between_checks, whitelisted_senders = load_setup()
...
def check_mails():
    global active, days, release_time_str, seconds_between_checks, whitelisted_senders
    ...
    for msg in msgs:
        ...
        if mail["sender"] in whitelisted_senders:
            ...
            if mail["title"].lower() == "config":
                ...
                logging.info("OLD config: %s", {"active": active, "days": days, "release_time_str": release_time_str, "seconds_between_checks": seconds_between_checks, "whitelisted_senders": whitelisted_senders})
                ...
                logging.info("NEW config: %s", {"active": active, "days": days, "release_time_str": release_time_str, "seconds_between_checks": seconds_between_checks, "whitelisted_senders": whitelisted_senders})

                # update the setup file
                with open("files/setup.json", "w") as f:
                    json.dump({"active": active, "days": days, "release_time_str": release_time_str, "seconds_between_checks": seconds_between_checks, "whitelisted_senders": whitelisted_senders}, f)
